...
def random(t, q, counts=None):
    """Random strategy"""
    return np.random.randint(len(q))


def fixed_greedy(epsilon, t, q, counts=None):
...
def fixed_softmax(tau, t, q, counts=None):
...
class Strat2D:
    ...
    def __call__(self, t, q, counts):
        ...
        return self.strat(t, qb), self.strat(t, qa)
